          ...
          <div class="row">
              ...
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <h6>{{$homeData->company_name}}</h6>
                    <h2>{{$homeData->title}}</h2>
                    <p>{{$homeData->details}}</p>
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <?php
                $imageData = base64_decode($homeData->image);
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="about-left-image  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                ...
                <?php
                $imageData = base64_decode($aboutData->image);
                $finfo = new finfo(FILEINFO_MIME_TYPE);
                $imageType = $finfo->buffer($imageData);
                ?>
                <img src='data:<?php echo $imageType; ?>;base64,<?php echo base64_encode($imageData); ?>' alt='Image' class="img-thumbnail">
            ...
            <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="about-right-content">
                ...
                <p>{{$aboutData->details}}</p>
                <div class="row">
                  <div class="col-lg-4 col-sm-4">
                    <div class="skill-item first-skill-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                      <div class="progress" data-percentage="{{$aboutData->coding_percentage}}">
                        ...
                        <div class="progress-value">
                          <div>
                            {{$aboutData->coding_percentage}}%<br>
                            <span>Coding</span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <div class="skill-item second-skill-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                      <div class="progress" data-percentage="{{$aboutData->photoshop_percentage}}">
                        <span class="progress-left">
                          <span class="progress-bar"></span>
                        </span>
                        <span class="progress-right">
                        ...
                        <div class="progress-value">
                          <div>
                            {{$aboutData->photoshop_percentage}}%<br>
                            <span>Photoshop</span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-lg-4 col-sm-4">
                    <div class="skill-item third-skill-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                      <div class="progress" data-percentage="{{$aboutData->animation_percentage}}">
                        <span class="progress-left">
                          <span class="progress-bar"></span>
                        </span>
                        <span class="progress-right">
                        ...
                        <div class="progress-value">
                          <div>
                            {{$aboutData->animation_percentage}}%<br>
                            <span>Animation</span>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="row">
                            <div class="col-lg-6 align-self-center">
                              <div class="left-text">
                                ...
                                <p>{{ $serviceInfo->service_detail }}</p>
                                <div class="ticks-list">
                                 <span><i></i> {{ $serviceInfo->service_category }}</span>
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                ...
                                <?php
                                $imageData = base64_decode($serviceInfo->image);
                                $finfo = new finfo(FILEINFO_MIME_TYPE);
                                $imageType = $finfo->buffer($imageData);
                                ?>
                                <img src='data:<?php echo $imageType; ?>;base64,<?php echo base64_encode($imageData); ?>' alt='Image' class="img-thumbnail">
                ...
                <a href="#">
                  <div class="portfolio-item">
                    <div class="thumb">
                      ...
                      <?php
                      $imageData = base64_decode($projectData->image);
                      $finfo = new finfo(FILEINFO_MIME_TYPE);
                      $imageType = $finfo->buffer($imageData);
                      ?>
                      <img src='data:<?php echo $imageType; ?>;base64,<?php echo base64_encode($imageData); ?>' alt='Image' class="img-thumbnail">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="blog-post">
                <!-- Assuming you have a single featured blog post -->
                <div class="thumb">
                  ...
                  <div class="col-lg-12">
                    <div class="post-item">
                      <div class="thumb">
                        ...
                        <?php
                        $imageData = base64_decode($blogData->image);
                        $finfo = new finfo(FILEINFO_MIME_TYPE);
                        $imageType = $finfo->buffer($imageData);
                        ?>
                        <img src='data:<?php echo $imageType; ?>;base64,<?php echo base64_encode($imageData); ?>' style="max-height: 230px;" alt='Image' class="img-thumbnail">
                        @else
                        No Image
                        @endif
                      </div>
                      <div class="right-content">
                        ...
                        <span class="category">SEO Analysis</span>
                        <span class="date">{{ \Carbon\Carbon::parse($blogData->date)->format('d F Y') }}</span>
